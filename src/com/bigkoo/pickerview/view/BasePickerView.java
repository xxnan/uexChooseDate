...
//            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.layout_basepickerview, null, false);
        	dialogView = (ViewGroup) layoutInflater.inflate(EUExUtil.getResLayoutID("layout_basepickerview"), null, false);
            //设置界面的背景为透明
...
//            contentContainer = (ViewGroup) dialogView.findViewById(R.id.content_container);
            ...
            rootView = (ViewGroup) layoutInflater.inflate(EUExUtil.getResLayoutID("layout_basepickerview"), decorView, false);
...
//            contentContainer = (ViewGroup) rootView.findViewById(R.id.content_container);
    ...
    protected BasePickerView setOutSideCancelable(boolean isCancelable) {
        if (rootView != null) {
            View view = rootView.findViewById(EUExUtil.getResIdID("outmost_container"));
    ...
    public void createDialog() {
        if (dialogView != null) {
            mDialog = new Dialog(context,EUExUtil.getResStyleID("custom_dialog2"));
            mDialog.setCancelable(cancelable);//不能点外面取消,也不 能点back取消
            mDialog.setContentView(dialogView);
            mDialog.getWindow().setWindowAnimations(EUExUtil.getResStyleID("pickerview_dialogAnim"));
