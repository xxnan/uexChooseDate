...
public class WheelOptions<T> {
    ...
    public WheelOptions(View view, Boolean linkage) {
        ...
        this.view = view;
        wv_option1 = (WheelView) view.findViewById(EUExUtil.getResIdID("options1"));// 初始化时显示的数据
        wv_option2 = (WheelView) view.findViewById(EUExUtil.getResIdID("options2"));
        wv_option3 = (WheelView) view.findViewById(EUExUtil.getResIdID("options3"));
    }
