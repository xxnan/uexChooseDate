...
public class WheelTime {
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int s) {
      ...
      /*  final Context context = view.getContext();*/
        currentYear = year;
        // 年
        wv_year = (WheelView) view.findViewById(EUExUtil.getResIdID("year"));
        ...
        // 月
        wv_month = (WheelView) view.findViewById(EUExUtil.getResIdID("month"));
        if (startYear == endYear) {//开始年等于终止年
            wv_month.setAdapter(new NumericWheelAdapter(startMonth, endMonth,"月"));
            wv_month.setCurrentItem(month + 1 - startMonth);
        } else if (year == startYear) {
            //起始日期的月份控制
            wv_month.setAdapter(new NumericWheelAdapter(startMonth, 12,"月"));
            wv_month.setCurrentItem(month + 1 - startMonth);
        } else if (year == endYear) {
            //终止日期的月份控制
            wv_month.setAdapter(new NumericWheelAdapter(1, endMonth,"月"));
     ...
     /*   wv_month.setLabel(context.getString(R.string.pickerview_month));*/
        ...
        if (startYear == endYear && startMonth == endMonth) {
            if (list_big.contains(String.valueOf( month + 1))) {
                ...
                wv_day.setAdapter(new NumericWheelAdapter(startDay, endDay,"日"));
            ...
            if (list_big.contains(String.valueOf(month + 1 ))) {
                ...
                wv_day.setAdapter(new NumericWheelAdapter(startDay, 31,"日"));
            } else if (list_little.contains(String.valueOf(month + 1 ))) {

                wv_day.setAdapter(new NumericWheelAdapter(startDay, 30,"日"));
            } else {
                // 闰年
                if ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0) {

                    wv_day.setAdapter(new NumericWheelAdapter(startDay, 29,"日"));
                } else {

                    wv_day.setAdapter(new NumericWheelAdapter(startDay, 28,"日"));
                }
            }
            wv_day.setCurrentItem(day - startDay);
            ...
            if (list_big.contains(String.valueOf(month + 1 ))) {
                ...
                wv_day.setAdapter(new NumericWheelAdapter(1, endDay,"日"));
            } else if (list_little.contains(String.valueOf(month + 1 ))) {
                if (endDay > 30) {
                    endDay = 30;
                }
       ...
       /* wv_day.setLabel(context.getString(R.string.pickerview_day));*/
        ...
        //时
        wv_hours = (WheelView) view.findViewById(EUExUtil.getResIdID("hour"));
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23,"时"));
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);
        //分
        wv_mins = (WheelView) view.findViewById(EUExUtil.getResIdID("min"));
        wv_mins.setAdapter(new NumericWheelAdapter(0, 59,"分"));
       /* wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字*/
        wv_mins.setCurrentItem(m);
        wv_mins.setGravity(gravity);
        //秒
        wv_seconds = (WheelView) view.findViewById(EUExUtil.getResIdID("second"));
        wv_seconds.setAdapter(new NumericWheelAdapter(0, 59,"秒"));
    ...
    private void setReDay(int year_num, int monthNum, int startD, int endD, List<String> list_big, List<String> list_little) {
        ...
        if (list_big
            ...
            wv_day.setAdapter(new NumericWheelAdapter(startD, endD,"日"));
            maxItem = endD;
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        if (label_month!=null){
            ...
            wv_month.setLabel(view.getContext().getString(EUExUtil.getResStringID("pickerview_month")));
        }
        if (label_day!=null){
            wv_day.setLabel(label_day);
        }else {
            wv_day.setLabel(view.getContext().getString(EUExUtil.getResStringID("pickerview_day")));
        }
        if (label_hours!=null){
            wv_hours.setLabel(label_hours);
        } else {
            wv_hours.setLabel(view.getContext().getString(EUExUtil.getResStringID("pickerview_hours")));
        }
        if (label_mins!=null){
            wv_mins.setLabel(label_mins);
        }else {
            wv_mins.setLabel(view.getContext().getString(EUExUtil.getResStringID("pickerview_minutes")));
        }
        if (label_seconds!=null){
            wv_seconds.setLabel(label_seconds);
        }else {
            wv_seconds.setLabel(view.getContext().getString(EUExUtil.getResStringID("pickerview_seconds")));
        }
