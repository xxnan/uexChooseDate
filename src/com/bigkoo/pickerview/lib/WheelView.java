...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
       ...
       /* textColorOut = getResources().getColor(R.color.pickerview_wheelview_textcolor_out);
        ...
        textSize = getResources().getDimensionPixelSize(EUExUtil.getResDimenID("pickerview_textsize"));//默认大小
        ...
        /*if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs,EUExUtil.getResStyleableID("pickerview"), 0, 0);
            mGravity = a.getInt(EUExUtil.getResStyleableID("pickerview_pickerview_gravity"), Gravity.CENTER);
            textColorOut = a.getColor(EUExUtil.getResStyleableID("pickerview_pickerview_textColorOut"), textColorOut);
            textColorCenter = a.getColor(EUExUtil.getResStyleableID("pickerview_pickerview_textColorCenter"), textColorCenter);
            dividerColor = a.getColor(EUExUtil.getResStyleableID("pickerview_pickerview_dividerColor"), dividerColor);
            textSize = a.getDimensionPixelOffset(EUExUtil.getResStyleableID("pickerview_pickerview_textSize"), textSize);
            lineSpacingMultiplier = a.getFloat(EUExUtil.getResStyleableID("pickerview_pickerview_lineSpacingMultiplier"), lineSpacingMultiplier);
            a.recycle();//回收内存
        }*/
    ...
    private String getContentText(Object item) {
        if (item == null) {
            ...
            //如果为整形则最少保留两位数.
            return String.format(Locale.getDefault(), "%02d", Integer.parseInt(String.valueOf(item)));
        }
