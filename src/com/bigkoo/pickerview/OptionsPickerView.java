...
//        private int layoutRes = R.layout.pickerview_options;
        private int layoutRes = EUExUtil.getResLayoutID("pickerview_options");
        private CustomListener customListener;
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            rv_top_bar = (RelativeLayout)findViewById(EUExUtil.getResIdID("rv_topbar"));
        ...
        // ----滚轮布局
        final LinearLayout optionsPicker = (LinearLayout) findViewById(EUExUtil.getResIdID("optionspicker"));
