...
//        private int layoutRes = R.layout.pickerview_time;
    	private int layoutRes = EUExUtil.getResLayoutID("pickerview_time");
        private CustomListener customListener;
...
//            LayoutInflater.from(context).inflate(R.layout.pickerview_time, contentContainer);
        	 LayoutInflater.from(context).inflate(EUExUtil.getResLayoutID("pickerview_time"),contentContainer);

            //顶部标题
            tvTitle = (TextView) findViewById(EUExUtil.getResIdID("tvTitle"));

            //确定和取消按钮
            btnSubmit = (Button) findViewById(EUExUtil.getResIdID("btnSubmit"));
            btnCancel = (Button) findViewById(EUExUtil.getResIdID("btnCancel"));
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(EUExUtil.getResStringID("pickerview_submit")) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(EUExUtil.getResStringID("pickerview_cancel")) : Str_Cancel);
            ...
            RelativeLayout rv_top_bar = (RelativeLayout) findViewById(EUExUtil.getResIdID("rv_topbar"));
        ...
        // 时间转轮 自定义控件
        LinearLayout timePickerView = (LinearLayout) findViewById(EUExUtil.getResIdID("timepicker"));
